...
def reset_for_testing() -> None:
    ...
    """
    global _skills_loader, _lesson_store
    with _lock:
        _cache.clear()
...
def read_memory_migrated() -> Optional[int]:
    ...
    ever read 1. What *is* a real fleet question is how far the migration to the
    vector store has reached, which is exactly this bit.
