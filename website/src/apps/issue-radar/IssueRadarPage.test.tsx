...
describe('IssueRadarPage — the active repository it hands down', () => {
  ...
  it('heals a stored slug-only pointer from the connected record', async () => {
    // The legacy-upgrade path: the pointer predates GitLab support, the record
    // does not. Matching on the slug and returning the POINTER is what left the
    // forge off; returning the RECORD is what fixes it.
