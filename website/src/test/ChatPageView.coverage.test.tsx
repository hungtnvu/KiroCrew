...
function makeProps(): ChatPageViewProps {
  ...
  return {
    ...
    composer: {
      ...
      sttDictationPanel: false, sttProvider: 'native', toggleDefaultAgent: fn(), toggleVoice: fn(),
      ...
      voiceCaretRef: ref(null), voiceDisabledReason: '', voiceOwned: false, voicePendingCaretRef: ref(null), voiceSetupOpen: false,
    },
    layout: {
