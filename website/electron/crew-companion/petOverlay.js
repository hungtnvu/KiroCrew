...
function registerOverlayIpc() {
  ...
  ipcMain.on("crew-companion:pet-ready", (event) => {
    ...
    if (isPetWindow(win)) {
      ...
      // Deliver any window commands that arrived while this overlay was still loading,
      // in the order they were drained, now that its onWindowCommand listener is mounted.
      if (win === overlays.get(activeDisplayId) && pendingWindowCommands.length) {
